      ...
      <div className="h-full flex flex-col items-center justify-center px-4">
        <div className="w-full max-w-2xl mx-auto">
          ...
          <p className="text-center text-stone-500 mt-3 text-base sm:text-lg font-light">
            Describe your experience in a sentence or two — I&apos;ll generate a complete first draft,
            then you refine it by chat or by hand.
          </p>
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-2.5">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-white border border-stone-300 text-[#1a1a1a] text-sm font-medium hover:border-[#0A2647]/40 hover:bg-stone-50 shadow-sm hover:shadow-md transition-all disabled:opacity-40"
            >
              <Sparkles className="h-4 w-4 text-[#0A2647]" />
