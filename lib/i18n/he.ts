...
const core: Record<string, string> = {
  ...
  Toolkit: "ארגז כלים",
  "Career toolkit": "ארגז כלים לקריירה",
  "Free tools for every step after the CV.": "כלים חינמיים לכל שלב אחרי קורות החיים.",

  // ── Review studio segments + feedback ─────────────────────────────────────
  Overview: "סקירה",
  "Job fit": "התאמה למשרה",
  Fixes: "תיקונים",
  "What's working": "מה עובד",
  "Next steps": "הצעדים הבאים",
  "Strong match — apply now": "התאמה חזקה — הגישו עכשיו",
  "Apply now": "הגישו עכשיו",
  "Apply with a strong cover letter": "הגישו עם מכתב מקדים חזק",
  "Stretch — tailor hard first": "מתיחה — התאימו היטב קודם",
  "Not a fit as-is": "לא מתאים כמו שזה",
  "{count} fixes": "{count} תיקונים",
  "Job requirements": "דרישות המשרה",
  "In your CV": "בקורות החיים שלכם",
  Missing: "חסר",
  "Added by fixes": "נוסף בתיקונים",
  critical: "קריטי",
  moderate: "בינוני",
  minor: "מינורי",

  // ── Toolkit tools ──────────────────────────────────────────────────────────
  "Cold email": "אימייל יזום",
  "A personal intro to a hiring manager or founder": "פנייה אישית למגייס או למייסד",
  "Application answers": "תשובות לטפסי הגשה",
  "Tailored answers for application form questions": "תשובות מותאמות לשאלות בטפסי הגשה",
  "LinkedIn profile": "פרופיל לינקדאין",
  "Headline options + About section from your CV": "כותרות ואודות מתוך קורות החיים",
  "Permission ask, briefing email, formatted list": "בקשת אישור, תדרוך ורשימה מסודרת",
  "Salary negotiation": "משא ומתן על שכר",
  "Counter script + total-comp checklist for your offer": "תסריט נגד ורשימת בדיקה להצעה שלכם",
  "Offer comparison": "השוואת הצעות",
  "Two offers, one weighted decision matrix": "שתי הצעות, מטריצת החלטה אחת",
  "Portfolio case study": "קייס סטאדי לתיק עבודות",
  "Turn one achievement into a full case study": "הפכו הישג אחד לקייס סטאדי מלא",
  "Interview prep": "הכנה לראיון",
  "STAR answers + your 30-second pitch": "תשובות STAR והנאום של 30 השניות",
  "Generated with your CV analysis": "נוצר עם ניתוח קורות החיים",
  "Using your builder CV": "משתמש בקורות החיים מהבונה",
  "Paste your CV text": "הדביקו את טקסט קורות החיים",
  "Your CV": "קורות החיים שלכם",
  Generate: "יצירה",
  "Writing…": "כותב…",
  "Start over": "התחלה מחדש",
  "Weighted total": "סה\"כ משוקלל",
  Factor: "גורם",
  Privacy: "פרטיות",
  Terms: "תנאים",
